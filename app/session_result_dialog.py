...
class SessionResultDialog(QDialog):
    def __init__(self, parent=None, stats=None, is_new_best=False, is_race=False,
        ...
        if is_frozen_linux:
            # PyInstaller on Linux often lacks proper Wayland/XCB composition plugins,
            # causing Frameless/Translucent windows to be completely invisible, 
            # blocking the app while appearing frozen.
